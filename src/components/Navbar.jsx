...
const Navbar = () => {
  ...
  return (
    <nav className="text-gray-200 w-full flex justify-between items-center fixed top-0 z-50 px-8">
      ...
      >
        <ul className="flex flex-col lg:flex-row lg:static fixed lg:w-fit lg:h-fit w-full h-full items-center justify-evenly py-24 lg:py-0 font-bold text-4xl lg:text-base gap-4  p-8 ">
          <li onClick={()=> setNav(!nav)} className="md:hover:text-cyan-500 transition-colors duration-200">
            <a href="#home">Home</a>
          </li>
          <li onClick={()=> setNav(!nav)} className="md:hover:text-cyan-500 transition-colors duration-200">
